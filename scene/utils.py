...
def get_floor_info(filename):
    ...
    for room_info in room_floors['floorplan']:
        ...
        floor_dict[room_id] = {
            'sceneid': room_floors['uid'],
            'instanceid': room_info['room'],
            'floor': floor_info,
            'area': room_info['area'],
            'door': room_info['door'],
            'doorinfo': room_info['doorinfo'],
            'hole': room_info['hole'],
            'holeinfo': room_info['holeinfo'],
            'window': room_info['window'],
            'windowinfo': room_info['windowinfo']
        }
